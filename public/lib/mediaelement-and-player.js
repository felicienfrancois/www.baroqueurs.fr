            ...
            var _plural = function _plural(input, number, form) {
              ...
              var _pluralForms = (function () {
                return [
                  ...
                  function () {
                    return (arguments.length <= 0 ? undefined : arguments[0]) === 0 || (arguments.length <= 0 ? undefined : arguments[0]) === 1
                      ? arguments.length <= 1
                        ? undefined
                        : arguments[1]
                      : arguments.length <= 2
                  ...
                  function () {
                    if ((arguments.length <= 0 ? undefined : arguments[0]) === 1) {
                      ...
                      ((arguments.length <= 0 ? undefined : arguments[0]) % 100 > 0 && (arguments.length <= 0 ? undefined : arguments[0]) % 100 < 20)
                    ) {
                      return arguments.length <= 2 ? undefined : arguments[2];
                    } else {
                      return arguments.length <= 3 ? undefined : arguments[3];
                  ...
                  function () {
                    if ((arguments.length <= 0 ? undefined : arguments[0]) === 1) {
                      ...
                      (arguments.length <= 0 ? undefined : arguments[0]) === 0 ||
                      ((arguments.length <= 0 ? undefined : arguments[0]) % 100 > 1 && (arguments.length <= 0 ? undefined : arguments[0]) % 100 < 11)
                    ) {
                      return arguments.length <= 2 ? undefined : arguments[2];
                    } else if (
                      (arguments.length <= 0 ? undefined : arguments[0]) % 100 > 10 &&
                  ...
                  // 15:  Icelandic
                  function () {
                    return (arguments.length <= 0 ? undefined : arguments[0]) !== 11 && (arguments.length <= 0 ? undefined : arguments[0]) % 10 === 1
                      ? arguments.length <= 1
                        ? undefined
                        : arguments[1]
                      : arguments.length <= 2
            ...
            t.globalBind('mousemove', function (e) {
              ...
              if (fullscreenIsDisabled) {
                ...
                if (
                  ...
                  e.pageY > fullscreenBtnPos.top + t.fullscreenBtn.outerHeight(true) ||
                  e.pageX < fullscreenBtnPos.left ||
                  e.pageX > fullscreenBtnPos.left + t.fullscreenBtn.outerWidth(true)
                ) {
                  t.fullscreenBtn.css('pointer-events', '');
                  t.controls.css('pointer-events', '');
                  fullscreenIsDisabled = false;
              ...
              function (e) {
                if (media.duration !== Infinity) {
                  ...
                  controls
                    ...
                    .empty()
                    .html('<span class="' + t.options.classPrefix + 'broadcast">' + _i18n2.default.t('mejs.live-broadcast') + '</span>');
                }
              },
              false,
            );
            ...
            $(
              '<div class="' +
                ...
                ('<span class="' +
                  t.options.classPrefix +
                  'currenttime">' +
                  (0, _time.secondsToTimeCode)(0, player.options.alwaysShowHours) +
                  '</span>') +
                '</div>',
            ).appendTo(controls);
 ...
 */
              ...
              for (; i < lines.length; i++) {
                ...
                if (timecode && i < lines.length) {
                  ...
                  entries.push({
                    ...
                    start: (0, _time.convertSMPTEtoSeconds)(timecode[1]) === 0 ? 0.2 : (0, _time.convertSMPTEtoSeconds)(timecode[1]),
        ...
        var config = (exports.config = {
          ...
          keyActions: [
            ...
            },
            {
              ...
              action: function action(player, media) {
                if (
                  player.container.find('.' + config.classPrefix + 'volume-button>button').is(':focus') ||
          ...
          function MediaElementPlayer(node, o) {
            ...
            if ((_constants.IS_IPAD && t.options.iPadUseNativeControls) || (_constants.IS_IPHONE && t.options.iPhoneUseNativeControls)) {
                ...
                .focus(function (e) {
                  if (!t.controlsAreVisible && !t.hasFocus && t.controlsEnabled) {
                    ...
                    if (!_constants.HAS_MS_NATIVE_FULLSCREEN) {
                      ...
                      var btnSelector = (0, _dom.isNodeAfter)(e.relatedTarget, t.container[0])
              ...
              t.container.addClass(
                (_constants.IS_ANDROID ? t.options.classPrefix + 'android ' : '') +
                  (_constants.IS_IOS ? t.options.classPrefix + 'ios ' : '') +
                  (_constants.IS_IPAD ? t.options.classPrefix + 'ipad ' : '') +
                  (_constants.IS_IPHONE ? t.options.classPrefix + 'iphone ' : '') +
    ...
    */
            ...
            },
            {
              ...
              value: function buildkeyboard(player, controls, layers, media) {
                ...
                t.globalBind('keydown', function (event) {
                  ...
                  player.hasFocus =
                    $container.length !== 0 && $container.attr('id') === player.$media.closest('.' + t.options.classPrefix + 'container').attr('id');
      ...
      { 2: 2, 27: 27, 28: 28, 29: 29, 3: 3, 30: 30, 32: 32, 4: 4, 5: 5, 6: 6 },
    ],
    17: [
      function (_dereq_, module, exports) {
        'use strict';
    ...
    18: [
            ...
            if (typeof dashjs !== 'undefined') {
              ...
              (function () {
                settings.options.path =
                  typeof settings.options.path === 'string' ? settings.options.path : '//cdn.dashjs.org/latest/dash.mediaplayer.min.js';
                ...
                script.onload = script.onreadystatechange = function () {
                  if (
                    !done &&
                    (!this.readyState || this.readyState === undefined || this.readyState === 'loaded' || this.readyState === 'complete')
                  ) {
                    done = true;
      ...
      { 2: 2, 27: 27, 28: 28, 3: 3, 30: 30, 6: 6, 7: 7 },
    ],
    19: [
      function (_dereq_, module, exports) {
        'use strict';
                    ...
                    (function () {
                      ...
                      for (i = 0, il = fbEvents.length; i < il; i++) {
                        ...
                        if (
                          handler !== undefined &&
                          handler !== null &&
                          !(0, _general.isObjectEmpty)(handler) &&
                          typeof handler.removeListener === 'function'
                        ) {
      ...
      { 2: 2, 28: 28, 29: 29, 3: 3, 30: 30, 6: 6, 7: 7 },
    ],
    20: [
      function (_dereq_, module, exports) {
        'use strict';
        ...
        if (hasFlash) {
          ...
          var FlashMediaElementVideoRenderer = {
            ...
            canPlayType: function canPlayType(type) {
              return (
                (hasFlash && ['video/mp4', 'video/rtmp', 'audio/rtmp', 'rtmp/mp4', 'audio/mp4'].includes(type)) ||
                (!_constants.HAS_MSE && hasFlash && ['video/flv', 'video/x-flv'].includes(type))
              );
            },
          ...
          var FlashMediaElementHlsVideoRenderer = {
            ...
            canPlayType: function canPlayType(type) {
              return (
                !_constants.HAS_MSE &&
                hasFlash &&
                ['application/x-mpegurl', 'vnd.apple.mpegurl', 'audio/mpegurl', 'audio/hls', 'video/hls'].includes(type.toLowerCase())
              );
            },
      ...
      { 2: 2, 27: 27, 28: 28, 3: 3, 30: 30, 4: 4, 6: 6, 7: 7 },
    ],
    21: [
      function (_dereq_, module, exports) {
        'use strict';
        ...
        var NativeFlv = {
          ...
          loadScript: function loadScript(settings) {
            ...
            if (typeof flvjs !== 'undefined') {
              ...
              (function () {
                settings.options.path =
                  typeof settings.options.path === 'string' ? settings.options.path : '//cdnjs.cloudflare.com/ajax/libs/flv.js/1.1.0/flv.min.js';
        ...
        var NativeHls = {
          ...
          loadScript: function loadScript(settings) {
            ...
            if (typeof Hls !== 'undefined') {
              ...
              (function () {
                settings.options.path =
                  typeof settings.options.path === 'string' ? settings.options.path : '//cdn.jsdelivr.net/hls.js/latest/hls.min.js';
              ...
              (function () {
                ...
                script.onload = script.onreadystatechange = function () {
                  if (
                    !done &&
                    (!vimeoApi.readyState ||
                      vimeoApi.readyState === undefined ||
                      vimeoApi.readyState === 'loaded' ||
                      vimeoApi.readyState === 'complete')
                  ) {
                    done = true;
    ...
    27: [
      function (_dereq_, module, exports) {
        ...
        var SUPPORTS_NATIVE_HLS = (exports.SUPPORTS_NATIVE_HLS =
          IS_SAFARI || (IS_ANDROID && (IS_CHROME || IS_STOCK_ANDROID)) || (IS_IE && UA.match(/edge/gi) !== null));
